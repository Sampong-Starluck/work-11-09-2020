...
public class oop {
    ...
    public static void main(String[] args) {
        ...
        alp = in.next();
        if (alp.charAt(0) >= 65 && alp.charAt(0) <= 90) {
            if (alp.charAt(0) == 'A' || alp.charAt(0) == 'E' || alp.charAt(0) == 'I' || alp.charAt(0) == 'O'
                    || alp.charAt(0) == 'U') {
                System.out.printf("%c is a vowel in uppercase.", alp.charAt(0));
            } else {
                System.out.printf("%c is a consonant in uppercase.", alp.charAt(0));
            }
        } else if (alp.charAt(0) >= 97 && alp.charAt(0) <= 122) {
            if (alp.charAt(0) == 'a' || alp.charAt(0) == 'e' || alp.charAt(0) == 'i' || alp.charAt(0) == 'o'
                    || alp.charAt(0) == 'u') {
                System.out.printf("%c is a vowel in lowercase.", alp.charAt(0));
            } else {
                System.out.printf("%c is a consonant in lowercase.", alp.charAt(0));
            }
        } else if (alp.charAt(0) >= 48 && alp.charAt(0) <= 57) {
            System.out.printf("%c is a number.", alp.charAt(0));
        } else {
            System.out.printf("%c is a symbol.", alp.charAt(0));
        }
    }
}